...
const ConverterForm = () => {
  ...
  const getExchangeRate = async () => {
    ...
    const API_URL = `https://cdn.jsdelivr.net/npm/@fawazahmed0/currency-api@latest/v1/currencies/${fromCurrency.toLowerCase()}.json`;
    console.log(API_URL);
    if (isLoading) return;
    setIsLoading(true);
    ...
    try {
      ...
      console.log(data[fromCurrency.toLowerCase()][toCurrency.toLowerCase()]);
      const rate = (
        data[fromCurrency.toLowerCase()][toCurrency.toLowerCase()] * amount
      ).toFixed(2);
